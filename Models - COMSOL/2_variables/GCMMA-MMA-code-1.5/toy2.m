...
obj = (mpheval(model,'sens2.iobj1','dataonly','on','dataset','dset3'));
...
f_constraint = [mean(mpheval(model,'sens2.iobj2','dataonly','on','dataset','dset3'))];
%f_constraint = 0;

fval = [f_constraint(1)-constraint(2)];
